    ...
    <main className="min-h-screen w-full bg-white text-black dark:bg-black dark:text-white transition-colors duration-300">
      ...
      <section className="flex flex-col items-center justify-center text-center py-40 px-6 mt-12">
        ...
        >
          About{" "}
          <span
            className="pb-10 text-5xl md:text-6xl text-center font-extrabold tracking-tight 
          bg-linear-to-b from-blue-600 to-blue-300 
          dark:from-slate-600 dark:to-slate-50 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className="p-8 rounded-xl border border-gray-300 dark:border-gray-800 hover:border-cyan-700 dark:hover:border-cyan-400 transition-all shadow-lg dark:hover:shadow-gray-900/50 duration-700"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: idx * 0.1 }}
              className="text-center p-6 rounded-lg border border-gray-300 dark:border-gray-800  hover:border-cyan-700 dark:hover:border-cyan-400 transition-all shadow-lg dark:hover:shadow-gray-900/50 duration-500"
            >
              <motion.p
      ...
      <section className="py-20 px-8 max-w-4xl mx-auto text-center">
        <motion.div
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6 }}
          className="p-12 rounded-2xl border-2 border-gray-300 dark:border-gray-800 bg-linear-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 shadow-lg hover:border-cyan-700 transition-all duration-500"
        >
