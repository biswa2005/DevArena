...
export default function HackathonsPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-white px-6 py-24 mt-16">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="pb-10 text-5xl md:text-7xl text-center font-extrabold tracking-tight 
          bg-linear-to-b from-blue-600 to-blue-300 
          dark:from-slate-700 dark:to-slate-50 
          bg-clip-text text-transparent 
          drop-shadow-[0_8px_8px_rgba(0,0,0,0.12)"
        >
          Hackathons
        </motion.h1>
          ...
          <div className="inline-flex rounded-lg bg-gray-100 dark:bg-gray-800 p-1">
            <button
              className={`px-4 py-2 rounded-md text-sm font-medium transition ${
                filter === "all"
                  ? "bg-blue-50 text-blue-700 dark:bg-gray-900 dark:text-white shadow"
                  : "hover:bg-blue-100 dark:hover:bg-gray-700/60 text-gray-900 dark:text-white"
              }`}
